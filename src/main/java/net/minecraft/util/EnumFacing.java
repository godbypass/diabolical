...
public enum EnumFacing implements IStringSerializable
{
    ...
    private static final class EnumFacing$1 {
        ...
        private static int[] initializeAxisArray() {
            int[] array = new int[Axis.values().length];
            array[Axis.X.ordinal()] = 1;
            array[Axis.Y.ordinal()] = 2;
            array[Axis.Z.ordinal()] = 3;
            return array;
        }
        ...
        private static int[] initializePlaneArray() {
            int[] array = new int[Plane.values().length];
            array[Plane.HORIZONTAL.ordinal()] = 1;
            array[Plane.VERTICAL.ordinal()] = 2;
            return array;
        }
    }
